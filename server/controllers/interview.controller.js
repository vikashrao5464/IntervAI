...
export const generateQuestions = async (req, res) => {
    try {
        ...
        if (foundUser.credits < 50) {
            return res.status(400).json({ message: "Not enough credit, Minimum 50 required" });
        }
...
export const submitAnswer = async (req, res) => {
    try {
        ...
        // if timeLimit excceds
        if (timetaken > question.timeLimit) {
            question.score = 0;
            question.feedback = "Time Limit Exceeded. Answer not Evaluateed.";
