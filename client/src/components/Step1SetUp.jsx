      ...
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        ...
        >
          ...
          <p className='text-gray-600 mb-10'>
            Practise real interview scenerios powered by AI.Improve communication,technical skills, and confidence.
          </p>
        ...
        >
          ...
          <div className='space-y-5'>
            ...
            {analysisDone && (
              ...
              <h3 className='text-xl font-bold text-gray-800'>Resume Analysis Result</h3>
