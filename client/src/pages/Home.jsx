...
import { BsBarChart, BsClock, BsMic, BsRobot } from 'react-icons/bs'
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                className={`relative bg-white rounded-3xl border-2 border-green-100 hover:border-green-500 p-10 w-80 max-w-[90%] shadow-md
                ...
                [
                  {
                    ...
                    desc:"Scores communication ,techanical accuracy and confidence."
                  },
                  {
                    image:resumeImg,
                    icon:<BsFileEarmarkText size={20} />,
                    title:"Resume Based Interview",
                    desc:"Project sepecific  questions based on your resume and experience."
                  },
                  {
                    image:pdfImg,
                    icon:<BsFileEarmarkText size={20} />,
                    title:"Downloadable PDF report",
                    desc:"Detailed strength analysis and improvement suggestions."
                  },
                  {
                    image:analyticsImg,
                    icon:<BsBarChart size={20} />,
                    title:"Analytics & History ",
                    desc:"Track your progress with insights on performance trends."
                  }
                ].map((item,index)=>(
                  <motion.div
                  key={index}
                  ...
                  hover:shadow-xl transition-all'>
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                      ...
                      <div className='bg-green-50 text-green-600 w-12 h-12 rounded-full flex items-center justify-center mb-6'>
                        {item.icon}
                      </div>
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    title:"Techanical mode",
                    desc:"Deep Techanical questioning based on selected role."
                  },
                  {
                    img:confidenceImg,
